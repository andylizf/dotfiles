...
- **单音节压缩**：为省字把双音节词砍成单字，念出来像公文或古文，不像人说话。
  ...
  - 命中：“说完不再**争**”（→ 就不争了）、“我没法回头**认**自己违反了它”（→ 承认）、
    ...
    “真的**谢**”（→ 真的谢谢你）
  - 不命中：“这个我**认**，下次注意”“这个你**定**，我没意见”“我**看**行”：高频动词
    带前置的简单宾语，是现成的口语说法，砍掉反而假。补出来的下半句不是可有可无的，
    这三个搭配单独成句、以句号收尾就命中判据三
  - 判据一，查词：**这个字有没有你日常真会说的双音节形式**：谢→谢谢、辩→争辩、
    泄→泄气、判→判断、争→争论。有就是压缩，换回去。例外是本来就能单说的高频动词：
    认、定、看、行、说、做、想、要、给、去、来，这十一个只在句中成立，句末看判据三。
  - 判据二，查句法：**高频单字动词后面跟小句或复杂宾语，也得换**。
    “这个我认”可以，“我没法回头认自己违反了它”不行（→ 承认）。
  - 判据三，查位置：**落在句末的单字动词一律要换**，判据一二的例外在这里全部不适用。
    “我到现在还在用。”“等下次回国就去。”“这个我认。”句号前只剩一个动词，句子还差
    一口气收不住，收尾那句尤其明显。改法是把动词后面缺的那截补上，三种：补宾语
    （“等下次回国就去。”→“等下次回国，我回学校看您。”），补一个说出结果的补语
    （“这个我慢慢想。”→“这个我慢慢想清楚。”），加语气助词（“这个我认。”→“这个我
    认了。”）。助词那种最轻，页边笔记和短消息用它，语域不会被抬上去。三种都不通，
    说明这句话本身没说完，重写整句。
  - 定稿时把中文里的单字动词逐个找出来，对照这三条查一遍
...
- **替对方安排心情**：“您别惦记。”“您一定很忙吧。”“相信您能理解。”这类句子的前提是
  ...
  判据是这个前提在这段字里有没有出处：“保重身体”不预设任何事，干净；“粉笔灰伤手，
  拿这个护护手”的前提写在前半句里，也干净；“您别惦记”凭空，删。它比客套话难查，
  因为伪装成关心，而不是伪装成礼貌。
- **口号化**：正文里的标语腔，改成平实陈述。
